...
<?php
  ...
  if($_SESSION['nivel'] != 'Professor' && $_SESSION['nivel'] != 'Administrador'){
               ...
               <li class="nav-item dropdown mr-3">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-default"
                      ...
                      <? if($_SESSION['nivel'] == 'Administrador'){ ?>
                        ...
                        <a class="dropdown-item" href="../painel_professor/painel_professor.php">PAINEL DOS PROFESSORES</a>
                ...
                <li class="nav-item avatar mt-1 mr-1">
                  ...
                  <span class="py-2 "><a class="text-light" href="painel_professor.php?acao=perfil&cpf=<?php echo $_SESSION['cpf']; ?> "><? echo $nome  ?> </span></a>
    ...
    <div class="col-lg-2 col-md-3 col-sm-12">
      ...
      <div class="bg-light" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
           ...
           <span href="#" class=" list-group-item ativo">Painel Professor</span>
          
          <a href="painel_professor.php?acao=perfil&cpf=<?php echo $_SESSION['cpf']; ?>" class="list-group-item list-group-item-action bg-light"><i class="fas fa-user-friends mr-1"></i>Editar Perfil</a>
          <a href="painel_professor.php?acao=cursos&cpf=<?php echo $_SESSION['cpf']; ?>" class="list-group-item list-group-item-action bg-light"><i class="fas fa-book-reader mr-1"></i>Curso</a>
