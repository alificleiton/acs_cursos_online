             ...
             <ul class="navbar-nav ml-auto nav-flex-icons">
               ...
               <li class="nav-item dropdown mr-3">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-default"
                      ...
                      <a class="dropdown-item" href="../painel_aluno/painel_aluno.php">PAINEL DOS ALUNOS</a>
                    </div>
                </li>
                ...
                <li class="nav-item avatar mt-1 mr-1">
                  ...
                  <span class="py-2 text-light"><? echo $_SESSION['nome'] ?> </span>
  ...
  <div class="row">
    ...
    <div class="col-lg-10 col-md-9 col-sm-12">
      ...
      <?php
        ...
        }else if(@$_GET['acao'] == 'categorias' or isset($_GET['txtpesquisarCategorias'])){
